...
import type { Position, TextSelectionSchema } from '../types/text-selection-schema';
...
export const textSelectorSlice = createSlice({
	...
	reducers: {
		...
		setTranslatedText: (state, action: PayloadAction<TextSelectionSchema['translatedText']>) => {
