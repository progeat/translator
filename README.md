...
2. Create service account [yandex console](https://yandex.cloud/ru/docs/iam/operations/sa/create)
3. Create 2 api keys:
   - API key for translate service
   - API key for speechkit service
4. Retrieve folder ID from console
5. Fill `.env.local` with provided keys
